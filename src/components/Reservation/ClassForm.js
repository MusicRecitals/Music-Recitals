        ...
        <div className="Form">
          ...
          <form>
            ...
            <div>
              ...
              <input type="radio" value="Cancelled" name="status" /> Daily | &nbsp;
              <input type="radio" value="Deleted" name="status" /> Weekly | &nbsp;
              <input type="radio" value="Cancelled" name="status" /> Monthly | &nbsp;
              <input type="radio" value="Cancelled" name="status" /> Yearly 
              &nbsp;
