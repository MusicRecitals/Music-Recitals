        ...
        <div className="Form">
          ...
          <form>
            <p className="Main">
              Event Type{" "}
              <select>
                <option value="cl">Rehearsal</option>
              </select>
            </p>
            <div className="Line"></div>
            ...
            <p className="Main">Parent Event</p>
            <TextField
              id="outline1"
              lable="ASU-ID2"
              variant="outlined"
            ...
            <table>
              <tr>
                <td>
                  <select>
                    <option value="ASUU1">NPMPK</option>
                    <option value="ASUU2">BNMOK</option>
                    <option value="ASUU3">MPOLM</option>
                    <option value="ASUU4">TYIUO</option>
                  </select>
                </td>
              </tr>
            </table>
            ...
            <div>
                <input value="ASU Gammge" type="checkbox"/>
                <label> Upright Piano session</label>
            </div>
            <div>
                      <input value="ASU Gammage" type="checkbox" />     
            ...
            <div>
                  <input value="ASU Gammage" typ="radio"/>

                  <lable> Harpsichord - French Double</lable>
                  <input value ="ASU Gammage" type="radio"/>
                  <lable> New Category for the music recitals</lable>
            </div>
            <div>
                      <input value="ASU Gammage" type="checkbox" />     
            ...
            <div>
              ...
              <label> New type of insturments to add here in future
              </label>
            </div>
            <div>
                      <input value="ASU Gammage" type="checkbox" />     
              <label>  Prepared Piano</label>
              <label> Bot to test in future</label>
            </div>
            <div>
                      <input value="ASU Gammage" type="checkbox" />     
              <label> None</label>
            ...
            <p className="Main 3"> Days of the Month</p>
            <table className="even3">
              <th>
                ...
                <td> 
                {""} 
                <input value="test 3" type="checkbox"/>
                 Tuesday |
                </td>
                  {" "}
                  <input value="test" type="checkbox" />
